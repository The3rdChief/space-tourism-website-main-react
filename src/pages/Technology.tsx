...
const TechnologiesData: TechnologiesType[] = [
  {
    name: "Launch vehicle",
    images: {
      potrait: "../src/assets/technology/image-launch-vehicle-portrait.jpg",
  ...
  },
  {
    name: "Spaceport",
    images: {
      potrait: "../src/assets/technology/image-spaceport-portrait.jpg",
  ...
  },
  {
    name: "Space capsule",
    images: {
      potrait: "../src/assets/technology/image-space-capsule-portrait.jpg",
...
const fetchData = async (): Promise<TechnologiesType[]> => {
  return Promise.resolve(TechnologiesData);
};
